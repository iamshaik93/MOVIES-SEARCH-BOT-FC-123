...
async def start(bot, cmd):
    ...
    if usr_cmdall1.startswith("/start ayita_p_s"):
        if AUTH_CHANNEL:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        ...
                        InlineKeyboardButton(' 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 ', url='https://t.me/mx_networks'),
                        InlineKeyboardButton(' 𝙶𝚛𝚘𝚞𝚙 ', url='https://t.me/mx_networks')
                    ]
                    ]
